      ...
      <header className='container mx-auto items-end justify-between space-y-2 px-3 pt-4 pb-4 md:flex md:px-6 md:pb-2 md:pt-8'>
        <h1 className='text-xl font-semibold lg:text-2xl'>
          <span className='block font-brand leading-none tracking-tighter'>
            2022 <span className='text-[#ec6d1f]'>Formula 1</span>
          </span>
          ...
          <section className='container mx-auto px-3 pt-2 pb-6 md:px-6'>
            <div className='space-y-1 border-y py-3'>
              ...
              <p className='lg:w-3/4'>
                ...
                <a className='text-[#ec6d1f] hover:text-[#e02b20] hover:underline font-semibold' href='https://github.com/planetscale/database-js'>
                  @planetscale/database
                </a>{' '}
                to query data over HTTP. Use the drop down to swap between different edge functions. See the source for
                each function{' '}
                <a className='text-[#ec6d1f] hover:text-[#e02b20] hover:underline font-semibold' href='https://github.com/planetscale/f1-championship-stats/tree/main/examples'>
                  here
                </a>
                .
              </p>
              <p className='lg:w-3/4 text-[#ec6d1f] font-bold'>&mdash;</p>
              <h3 className='text-sm font-semibold'>Adam Ennis & Alex Ozdowski:</h3>
              <p className='lg:w-3/4'>
